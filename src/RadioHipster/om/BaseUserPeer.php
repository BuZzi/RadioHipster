...
abstract class BaseUserPeer
{
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('UserId', 'UserName', 'UserEmail', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('userId', 'userName', 'userEmail', ),
        BasePeer::TYPE_COLNAME => array (UserPeer::USER_ID, UserPeer::USER_NAME, UserPeer::USER_EMAIL, ),
        BasePeer::TYPE_RAW_COLNAME => array ('USER_ID', 'USER_NAME', 'USER_EMAIL', ),
        BasePeer::TYPE_FIELDNAME => array ('user_id', 'user_name', 'user_email', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('UserId' => 0, 'UserName' => 1, 'UserEmail' => 2, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('userId' => 0, 'userName' => 1, 'userEmail' => 2, ),
        BasePeer::TYPE_COLNAME => array (UserPeer::USER_ID => 0, UserPeer::USER_NAME => 1, UserPeer::USER_EMAIL => 2, ),
        BasePeer::TYPE_RAW_COLNAME => array ('USER_ID' => 0, 'USER_NAME' => 1, 'USER_EMAIL' => 2, ),
        BasePeer::TYPE_FIELDNAME => array ('user_id' => 0, 'user_name' => 1, 'user_email' => 2, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, )
    );
    ...
    protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
    {
        ...
        foreach ($objects as $obj) {
            ...
            $criteria->add(SongPeer::USER_ID, $obj->getUserId());
