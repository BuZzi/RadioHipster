 ...
 *
 * @method UserQuery leftJoinSong($relationAlias = null) Adds a LEFT JOIN clause to the query using the Song relation
 * @method UserQuery rightJoinSong($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Song relation
 * @method UserQuery innerJoinSong($relationAlias = null) Adds a INNER JOIN clause to the query using the Song relation
 *
...
abstract class BaseUserQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'etuwebdev_radiohipster', $modelName = 'User', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT `user_id`, `user_name`, `user_email` FROM `user` WHERE `user_id` = :p0';
        try {
    ...
    public function filterBySong($song, $comparison = null)
    {
        if ($song instanceof Song) {
            return $this
                ->addUsingAlias(UserPeer::USER_ID, $song->getUserId(), $comparison);
