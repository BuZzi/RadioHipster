...
abstract class BaseAlbum extends BaseObject implements Persistent
{
    ...
    public function setAlbumName($v)
    {
        ...
        if ($this->album_name !== $v) {
            $this->album_name = $v;
            $this->modifiedColumns[] = AlbumPeer::ALBUM_NAME;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->album_name = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            $this->resetModified();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(AlbumPeer::ALBUM_ID)) {
            $modifiedColumns[':p' . $index++]  = '`album_id`';
        }
        if ($this->isColumnModified(AlbumPeer::ALBUM_NAME)) {
            $modifiedColumns[':p' . $index++]  = '`album_name`';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`album_id`':
                        ...
                        break;
                    case '`album_name`':
                        $stmt->bindValue($identifier, $this->album_name, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_FIELDNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) $this->setAlbumName($arr[$keys[1]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(AlbumPeer::ALBUM_NAME)) $criteria->add(AlbumPeer::ALBUM_NAME, $this->album_name);
    ...
    {
        $criteria = new Criteria(AlbumPeer::DATABASE_NAME);
        $criteria->add(AlbumPeer::ALBUM_ID, $this->album_id);
    ...
    {
        $copyObj->setAlbumName($this->getAlbumName());
