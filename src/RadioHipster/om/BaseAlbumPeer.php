...
abstract class BaseAlbumPeer
{
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('AlbumId', 'AlbumName', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('albumId', 'albumName', ),
        BasePeer::TYPE_COLNAME => array (AlbumPeer::ALBUM_ID, AlbumPeer::ALBUM_NAME, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ALBUM_ID', 'ALBUM_NAME', ),
        BasePeer::TYPE_FIELDNAME => array ('album_id', 'album_name', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('AlbumId' => 0, 'AlbumName' => 1, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('albumId' => 0, 'albumName' => 1, ),
        BasePeer::TYPE_COLNAME => array (AlbumPeer::ALBUM_ID => 0, AlbumPeer::ALBUM_NAME => 1, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ALBUM_ID' => 0, 'ALBUM_NAME' => 1, ),
        BasePeer::TYPE_FIELDNAME => array ('album_id' => 0, 'album_name' => 1, ),
        BasePeer::TYPE_NUM => array (0, 1, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(AlbumPeer::ALBUM_NAME);
        } else {
            $criteria->addSelectColumn($alias . '.album_id');
            $criteria->addSelectColumn($alias . '.album_name');
        }
    }
    ...
    public static function doInsert($values, PropelPDO $con = null)
    {
        ...
        if ($criteria->containsKey(AlbumPeer::ALBUM_ID) && $criteria->keyContainsValue(AlbumPeer::ALBUM_ID) ) {
            throw new PropelException('Cannot insert a value for auto-increment primary key ('.AlbumPeer::ALBUM_ID.')');
        }
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $comparison = $criteria->getComparison(AlbumPeer::ALBUM_ID);
            $value = $criteria->remove(AlbumPeer::ALBUM_ID);
            if ($value) {
                $selectCriteria->add(AlbumPeer::ALBUM_ID, $value, $comparison);
            } else {
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(AlbumPeer::ALBUM_ID, (array) $values, Criteria::IN);
        }
    ...
    protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
    {
        ...
        foreach ($objects as $obj) {
            ...
            $criteria->add(SongPeer::ALBUM_ID, $obj->getAlbumId());
    ...
    public static function retrieveByPK($pk, PropelPDO $con = null)
    {
        ...
        $criteria = new Criteria(AlbumPeer::DATABASE_NAME);
        $criteria->add(AlbumPeer::ALBUM_ID, $pk);
    ...
    public static function retrieveByPKs($pks, PropelPDO $con = null)
    {
        ...
        if (empty($pks)) {
            ...
            $criteria = new Criteria(AlbumPeer::DATABASE_NAME);
            $criteria->add(AlbumPeer::ALBUM_ID, $pks, Criteria::IN);
